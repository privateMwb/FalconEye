...
// clang-format off
#include <ArenaPro/Arena.h>      // core type under test — not directly used by this tool's own
#include <ArenaPro/ArenaScope.h> // code today; keep only if the main file needs it, otherwise drop
