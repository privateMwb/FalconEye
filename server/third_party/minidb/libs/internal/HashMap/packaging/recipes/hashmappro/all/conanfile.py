...
class Conan(ConanFile):
    ...
    # edited here.
    name = "hashmappro"
    cmake_name = "HashMapPro"  # matches project()'s name in the top-level CMakeLists.txt
    version = "1.0.0"

    url = "https://github.com/privateMwb/HashMapPro"
    description = "High-performance, header-only hash map with separate chaining, automatic rehashing, and power-of-two bucket sizing (bitmask indexing)."
    topics = (
        "hashmap",
        "hash-map",
        "hash-table",
    ...
    # header-library, not "library": there's no compiled src/HashMapPro/*.cpp
