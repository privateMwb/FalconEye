...
int main() {
    ...
    ArenaPro::Arena<> queryArena(1024 * 1024); // 1 MiB scratch space
    ...
    // once available.
    MiniDB::Common::Status createStatus = db.createTable(
        "todos", {
    ...
    MiniDB::Common::Status insertStatus = todosTable->insertRecord(seedRecord);
